...
var ErrRegisteredEmail = errors.New("this email address is already registered. please use a different one")
var ErrInvalidCredentials = errors.New("please check your username and password and try again.")
